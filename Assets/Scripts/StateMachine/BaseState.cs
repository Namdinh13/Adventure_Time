...
public abstract class BaseState : IState
{
    ...
    protected static readonly int StrafeHash = Animator.StringToHash("Strafe");
    ...
    protected static readonly int Punch1Hash = Animator.StringToHash("Punch1");
    protected static readonly int Punch2Hash = Animator.StringToHash("Punch2");
    protected static readonly int Punch3Hash = Animator.StringToHash("Punch3");
